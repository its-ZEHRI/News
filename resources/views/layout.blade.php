        ...
        <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
                ...
                <ul class="nav navbar-nav navbar-right user-nav">
                    <li class="user-name"><span>{{session('Admin_logged_in')}}</span></li>
            ...
            <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                        <a href="/home" class="nav-header"><span class="fa-home fa"></span> Home
                            <span class="fa-angle-right fa right-arrow text-right"></span>
                        </a>
                    </li>
                    <li class="ripple">
                        <a href="addNews" class=" nav-header">
                            <span class="fa-diamond fa"></span> Add News
                            <span class="fa-angle-right fa right-arrow text-right"></span>
                        </a>
                    </li>
                    <li class="ripple">
                        <a href="table" class=" nav-header">
                            <span class="fa-diamond fa"></span> News Table
                            <span class="fa-angle-right fa right-arrow text-right"></span>
                        </a>
                    </li>
                </ul>
    ...
    <div id="mimin-mobile" class="reverse">
        <div class="mimin-mobile-menu-list">
            <div class="col-md-12 sub-mimin-mobile-menu-list animated fadeInLeft">
                <ul class="nav nav-list">
                    <li class="active ripple">
                        <a href="home" class="tree-toggle nav-header">
                    ...
                    <li class="ripple">
                        <a href="addNews.blade.php" class="tree-toggle nav-header">
                            <span class="fa-diamond fa"></span> Add News
                            <span class="fa-angle-right fa right-arrow text-right"></span>
                        </a>
                    ...
                    <li class="ripple">
                        <a href="table" class="tree-toggle nav-header">
                            <span class="fa-area-chart fa"></span> Table
                            <span class="fa-angle-right fa right-arrow text-right"></span>
                        </a>
                    </li>
                </ul>
